...
router.get("/colaborador/actualizar", function (req, res, next) {
  res.sendFile(path.join(__dirname, "../views/colaborador/actualizar_colaborador.html"));
});
...
router.get("/departamento/actualizar", function (req, res, next) {
  res.sendFile(path.join(__dirname, "../views/departamento/actualizar_departamento.html"));
});
...
router.get("/status/actualizar", function (req, res, next) {
